...
var ASM_CONSTS = {
  1028: () => { console.log('set j to 50'); },  
 1060: () => { console.log('freed j'); },  
 1088: () => { console.log('starting'); },  
 1117: () => { console.log('ending'); },  
 1144: ($0, $1) => { { console.log('made node $0 of typ $1'); }nid },  
 1190: ($0, $1) => { { console.log('connected nodes $0 and $1'); }input_nid }
};
