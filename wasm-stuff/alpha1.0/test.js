...
function assignWasmExports(wasmExports) {
  _killNode = Module['_killNode'] = wasmExports['killNode'];
  _clearNodes = Module['_clearNodes'] = wasmExports['clearNodes'];
  _createNode = Module['_createNode'] = wasmExports['createNode'];
  _applyFunc = Module['_applyFunc'] = wasmExports['applyFunc'];
  _addParam = Module['_addParam'] = wasmExports['addParam'];
  _connectNodes = Module['_connectNodes'] = wasmExports['connectNodes'];
  _disconnectNodes = Module['_disconnectNodes'] = wasmExports['disconnectNodes'];
  _start = Module['_start'] = wasmExports['start'];
  _end = Module['_end'] = wasmExports['end'];
