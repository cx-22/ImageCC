...
GraphModel::GraphModel(std::shared_ptr<NodeDelegateModelRegistry> registry)
...
void GraphModel::sendConnectionDeletion(ConnectionId const connectionId)
{
...
QJsonObject GraphModel::save() const
{
...
void GraphModel::load(QJsonObject const &jsonDocument)
{
...
void GraphModel::onOutPortDataUpdated(NodeId const nodeId, PortIndex const portIndex)
{
...
void GraphModel::propagateEmptyDataTo(NodeId const nodeId, PortIndex const portIndex)
{
    QVariant emptyData{};
