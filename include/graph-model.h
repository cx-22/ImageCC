...
public:
    GraphModel(std::shared_ptr<NodeDelegateModelRegistry> registry);
...
private Q_SLOTS:
     ...
     *   @see GraphModel::addNode
     * - When a new connection is created.
     *   @see GraphModel::addConnection
     * - When a node restored from JSON an needs to send data downstream.
     *   @see GraphModel::loadNode
     */
